...
<div class="container uw-body">
  ...
  <div class="row">
    ...
    <div class="col-md-<?php echo (($sidebar[0]!='on') ? '8' : '12' ) ?>
      ...
      <?php uw_site_title(); ?><span class="udub-slant"><span></span></span><h3 class="uw-site-tagline" >Your connection to information technology at the UW</h3>
...
<input type="radio" name="feedOption" value="eoutage" onClick="makeURL('eoutage');"/> eOutages<br>
